...
namespace pkmn
{
    class PKMN_API pokemon
    {
        public:
            ...
            static sptr make(uint16_t species, uint16_t version,
                             uint16_t level,
            ...
            virtual uint8_t get_met_level() const = 0;
            ...
            virtual void set_met_level(uint8_t level) = 0;

            // Getting Individual Stat Info
            virtual uint32_t get_personality() const = 0;
            virtual uint8_t get_friendship() const = 0;
            ...
            virtual pkmn::dict<pkmn::pkstring, uint16_t> get_stats() const = 0;
            virtual pkmn::dict<pkmn::pkstring, uint16_t> get_EVs() const = 0;
            virtual pkmn::dict<pkmn::pkstring, uint16_t> get_IVs() const = 0;
            
            // Setting Individual Stat Info
            virtual void set_personality(uint32_t personality) = 0;
            virtual void set_friendship(uint8_t friendship) = 0;
            virtual void set_level(uint8_t level) = 0;
            ...
            virtual void set_EV(const pkmn::pkstring &stat, uint16_t value) = 0;
            virtual void set_IV(const pkmn::pkstring &stat, uint16_t value) = 0;
            ...
            // Setting Move Info
            virtual void set_move(const pkmn::pkstring &move_name, uint8_t pos) = 0;
            virtual void set_move_PP(uint8_t PP, uint8_t pos) = 0;
            ...
            // Database Info
            virtual uint16_t get_species_id() const = 0;
            virtual uint16_t get_game_id() const = 0;
            virtual uint16_t get_original_game_id() const = 0;
            virtual uint16_t get_pokemon_id() const = 0;
            virtual uint16_t get_ability_id() const = 0;
            virtual uint16_t get_item_id() const = 0;
            virtual uint16_t get_nature_id() const = 0;
            virtual uint16_t get_form_id() const = 0;
