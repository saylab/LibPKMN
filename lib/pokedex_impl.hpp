...
namespace pkmn
{
    class pokedex_impl: public pokedex
    {
        public:
            ...
            pokemon_entry_t& get_entry(const uint16_t species_id,
                                       const uint16_t form_id = 0);

            pokemon_entry_t& get_entry(const pkmn::pkstring& species_name,
        ...
        private:
            ...
            static pkmn::dict<uint16_t, pkmn::dict<uint16_t, pokemon_entry_t> > _entry_cache;
            ...
            float _get_gender_chance(const uint16_t species_id,
                                     uint8_t gender_rate,
                                     bool male) const;
            void _adjust_entry(pokemon_entry_t& entry);
    };
}
