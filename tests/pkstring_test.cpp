...
BOOST_AUTO_TEST_CASE(multibyte_to_wide)
{
    ...
    pkmn::pkstring test_pkmntext(test_str);
...
{
    std::wstring test_wstr(L"Test string");
    pkmn::pkstring test_pkmntext(test_wstr);
    std::string test_str("Test string");
...
{
    pkmn::pkstring test_pkmntext1("Test string");
    pkmn::pkstring test_pkmntext2("Test string");
